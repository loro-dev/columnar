use serde::{Serialize, Serializer, ser::{ SerializeSeq, SerializeStruct, SerializeMap, SerializeStructVariant, SerializeTuple, SerializeTupleStruct, SerializeTupleVariant}};
use crate::{ColumnarError, columnar_impl::ser::{low_bits_of_u64, CONTINUATION_BIT}};
use super::zigzag::{zig_zag_i16, zig_zag_i32, zig_zag_i64};
